# herdr `[[build]]` step (Windows): download the prebuilt herdr-edit.exe for this platform from
...
# with `cargo build --release` and copy target\release\herdr-edit.exe into bin\.
#
...
$Name = 'herdr-edit'
$Repo = 'aclima01/herdr-edit-windows'
